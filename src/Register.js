...
const register=(e)=>{
    ...
    return (
        <div className="register">
            <img src="https://static.xx.fbcdn.net/rsrc.php/y8/r/dF5SId3UHWd.svg" class="register__logo"></img>
                ...
                <form>
                    ...
                    <div className="register__radiocontainer">
                        <div className="wrapper">
                            <label>Female</label>
                            <input required onChange={(e)=>setGender(e.target.value)} type="radio" name="gender" value="Female"></input>
                        </div>

                        <div className="wrapper">
                            <label>Male</label>
                            <input required onChange={(e)=>setGender(e.target.value)} type="radio" name="gender" value="Male"></input>
                        </div>

                        <div className="wrapper">
                            <label>Other</label>
                            <input required onChange={(e)=>setGender(e.target.value)} type="radio" name="gender" value="Other"></input>
                        </div>
                    </div>
